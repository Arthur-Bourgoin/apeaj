...
class TestCreerpicto():
  ...
  def test_creerpicto(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".row:nth-child(2) > div:nth-child(1) > .btn-number:nth-child(2)").click()
    element = self.driver.find_element(By.CSS_SELECTOR, ".row:nth-child(2) > div:nth-child(1) > .btn-number:nth-child(2)")
    actions = ActionChains(self.driver)
    actions.double_click(element).perform()
    self.driver.find_element(By.CSS_SELECTOR, ".row:nth-child(2) > div:nth-child(1) > .btn-number:nth-child(3)").click()
    self.driver.find_element(By.CSS_SELECTOR, ".row:nth-child(2) > div:nth-child(1) > .btn-number:nth-child(3)").click()
    element = self.driver.find_element(By.CSS_SELECTOR, ".row:nth-child(2) > div:nth-child(1) > .btn-number:nth-child(3)")
    actions = ActionChains(self.driver)
    actions.double_click(element).perform()
    self.driver.find_element(By.CSS_SELECTOR, ".row:nth-child(2) > div:nth-child(1) > .btn-number:nth-child(3)").click()
    self.driver.find_element(By.CSS_SELECTOR, ".row:nth-child(2) > div > .btn-success").click()
    self.driver.find_element(By.CSS_SELECTOR, ".col-lg-2:nth-child(1)").click()
    self.driver.find_element(By.ID, "imgPicto").click()
    self.driver.find_element(By.ID, "inputImgPicto").send_keys("C:\\Users\\charl\\OneDrive\\Pictures\\PHOTO\\formation.png")
    self.driver.find_element(By.NAME, "title").click()
    self.driver.find_element(By.NAME, "title").send_keys(script_ajout)
    self.driver.find_element(By.NAME, "title").send_keys(Keys.ENTER)

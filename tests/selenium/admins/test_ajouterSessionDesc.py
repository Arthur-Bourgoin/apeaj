...
class TestAjouterSession():
  ...
  def test_ajouterSession(self):
    ...
    self.driver.find_element(By.ID, "sessionName").send_keys("test")
    self.driver.find_element(By.ID, "theme").send_keys("test")
    self.driver.find_element(By.ID, "startTime").click()
    self.driver.find_element(By.ID, "startTime").send_keys("2024-04-19T21:15")
    self.driver.find_element(By.ID, "description").click()
    self.driver.find_element(By.ID, "description").send_keys(script_ajout)

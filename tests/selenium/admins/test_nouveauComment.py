...
class TestNouveauComment():
  ...
  def test_nouveauComment(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".px-0 > .btn-primary").click()
    self.driver.find_element(By.ID, "Formtext").click()
    self.driver.find_element(By.ID, "Formtext").send_keys(script_ajout)
    self.driver.find_element(By.CSS_SELECTOR, "#ModalComs .btn-success").click()
    self.driver.find_element(By.CSS_SELECTOR, ".bi-trash").click()
    assert self.driver.switch_to.alert.text == "Voulez vous vraiment supprimer ce commentaire ?"
